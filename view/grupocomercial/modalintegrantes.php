        ...
        <div class="modal-content">
            ...
            <form method="post" id="integrantes_form">
                <div class="modal-body">
                    <input type="hidden" id="com_id_modal" name="com_id_modal" value="">
                    <div class="row">
                        <div class="col-lg-7">
                        ...
                        <div class="col-lg-5">
                            <div class="box-typical box-typical-padding">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" id="searchgcom" placeholder="Buscar..." onkeyup="filterResults()" class="form-control mb-2">

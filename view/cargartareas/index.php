        ...
        <div class="page-content">
            <header class="page-content-header">
                <div class="container-fluid">
                    <ol class="breadcrumb breadcrumb-simple">
                        ...
                        <li><a style="color:#5B80A3" href="../calendario/">Planificador</a></li>
                        <li class="active" id="tlb_camp">Cargar Tareas</li>
                    </ol>
                </div>
            </header>
            ...
            <div class="container-fluid">
                <div class="box-typical box-typical-padding" id="table">
                    <button type="button" id="btnnueva" class="btn btn-inline btn-primary">Cargar Tareas</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table id="dynamicTable" style="font-size: 14px;">
                        <thead>
                            <tr>
                                ...
                                <th style=" width: 10%; background: #c5d2de;" data-value="CEDULA">Titulo</th>
                                <th style=" width: 10%; background: #c5d2de;" data-value="NOMBRE">Categoria</th>
                                <th style=" width: 10%; background: #c5d2de;" data-value="TELEFONO">Descripción</th>
                                <th style=" width: 10%; background: #c5d2de;" data-value="CONVENIO">Ubicación</th>
                                <th style=" width: 10%; background: #c5d2de;" data-value="CIUDAD">Calendario</th>
                                <th style=" width: 10%;" data-value="DEPARTAMENTO">Fecha Inicio</th>
                                <th style=" width: 10%;" data-value="TELALTERNATIVO">Fecha Fin</th>
                                <th style=" width: 10%;" data-value="CORREO">Todo dia</th>
                                <th style=" width: 10%;" data-value="FECNACIMIENTO">Prioridad</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>

...
?>
	...
	<title>CRM :: Sucursales Entidades </title>
	</head>
	...
	<body class="with-side-menu">
		...
		<div class="page-content">
			<header class="page-content-header">
				<div class="container-fluid">
					<ol class="breadcrumb breadcrumb-simple">
						...
						<li class="active">Sucursales <span id="lbltitle"><?php echo htmlspecialchars($_GET['nom'] ?? ''); ?></span>
						</li>
					</ol>
			...
			<div class="container-fluid">
				<div class="box-typical box-typical-padding" id="table">
					<button type="button" id="btnnuevo" class="btn btn-inline btn-primary"><i class="fa fa-plus-circle"></i> Sucursal</button>

					<button type="button" id="papelera" class="btn btn-inline btn-danger"><i class="fa fa-trash"></i>&nbsp;Papelera</button>

					<table id="suc_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
		...
		<script type="text/javascript" src="sucursales.js"></script>
	</body>

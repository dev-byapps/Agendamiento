...
?>
	...
	<title>CRM :: Grupos Contact Center </title>
	...
	<body class="with-side-menu">
		...
		<div class="page-content">
			<header class="page-content-header">
				<div class="container-fluid">
					<ol class="breadcrumb breadcrumb-simple">
						...
						<li class="active">Grupos Contact Center</li>
					</ol>
				</div>
			</header>
			...
			<div class="container-fluid">
				<div class="box-typical box-typical-padding" id="table">
					...
					<table id="grupocc_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
		...
		<script type="text/javascript" src="grupoccenter.js"></script>
		<!-- Select2 JS -->
		<script src="../../public/js/lib/select2/select2.min.js"></script>

    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="mdltituloT"></h4>
            </div>
            <form method="post" id="tarea2_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea rows="5" class="form-control" id="tar_det" name="tar_det" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tar_asig" name="tar_asig" style="width: 100%;" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="action" id="btnguardar2" value="add" class="btn btn-primary" disabled>Guardar</button>
                </div>
            </form>
        </div>
    </div>
